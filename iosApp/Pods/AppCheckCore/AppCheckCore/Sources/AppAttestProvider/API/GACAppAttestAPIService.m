...
static NSString
*
const kRequestFieldArtifact = @"artifact";
...
*)randomChallengeFromResponseBody:(NSData *)
response error
:(NSError **)outError {
    ...
    if (![challenge isKindOfClass:[NSString class]]) {
        GACAppCheckSetErrorToPointer(
                [GACAppCheckErrorUtil appCheckTokenResponseErrorWithMissingField:@"challenge"],
                outError);
        return nil;
    }
