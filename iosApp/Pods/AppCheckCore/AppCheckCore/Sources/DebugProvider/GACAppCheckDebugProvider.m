...
static NSString
*
const kDebugTokenEnvKey = @"AppCheckDebugToken";
    ...
    [FBLPromise do:^NSString * {
        return [self currentDebugToken];
            ...
            .catch(^void(NSError *error) {
                ...
                GACAppCheckLogDebug(GACLoggerAppCheckMessageDebugProviderFailedExchange,
                                    logMessage);
                handler(nil, error);
            });
}
...
EnvironmentVariableDebugToken(void) {
